...
**Content area width.**
Law firm pages in Elementor constrain content well short of the full viewport, but don't assume a figure — the recorded content width on the Wright & Crawford reference sheet is 1080px, not the 750–900px this file used to claim. Measure the actual container width on the reference page (`document.querySelector('.entry-content, main').getBoundingClientRect().width`) and build and preview at that figure. Components that look correct at full width often break at content-area width.
